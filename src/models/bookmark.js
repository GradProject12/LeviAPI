  ...
  async fetchAllBookmarks(user_id, type) {
    try {
      ...
      if (type === "message")
        ...
        sql =
          "SELECT us.profile_image,pos.file,pos.body,pos.created_at,us.full_name,us.user_id,pos.post_id FROM posts AS pos JOIN bookmarks AS bk ON pos.post_id=bk.asset_id JOIN assets AS ass ON bk.asset_id=ass.asset_id JOIN users AS us ON us.user_id=ass.user_id WHERE bk.user_id=($1)";
